...
const pairs=[
 ...
 {a:/dry mix|no reverb|minimal reverb|dry (?:forward )?(?:lead )?vocal|close[- ]mic/i,b:/cathedral|huge reverb|heavy (?:vocal )?reverb|large hall|airy vocal reverb|reverb[- ]soaked vocal/i,name:'Space Conflict',why:'Dry close vocals and very reverberant vocal spaces compete unless assigned by section.',section:['[Verse | Intimate | Dry Forward Lead Vocal | Close Mic]','[Final Chorus | Large Hall Reverb]']},
 ...
 {a:/instrumental only|pure instrumental/i,b:/vocal|voice|choir|spoken|rap/i,name:'Performance Conflict',why:'Instrumental-only contradicts requested vocal performers.',section:['[Intro | Instrumental Only]','[Verse | Lead Vocal Enters]']},
 ...
 {a:/whisper/i,b:/wall of sound|massive drums|constant heavy drums/i,name:'Vocal Density Conflict',why:'Whispers need space and lower density to remain understandable.',section:['[Verse | Whispered Close-Mic Vocal | Sparse Percussion]','[Chorus | Powerful Vocal | Full Drums]']},
