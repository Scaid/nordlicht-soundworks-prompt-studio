...
const V207_I18N={
 en:["Add tempo character to BPM","Add lyrics language to Style","Controls lyrics tools only; omitted from Style by default.","Reliability","All levels","Reliability is a practical guidance value, not a guarantee."],
 de:["Tempo-Charakter zur BPM-Angabe hinzufügen","Lyrics-Sprache zum Style hinzufügen","Steuert nur die Lyrics-Werkzeuge; standardmäßig nicht im Style enthalten.","Zuverlässigkeit","Alle Stufen","Die Zuverlässigkeit ist ein praktischer Richtwert, keine Garantie."],
 fr:["Ajouter le caractère du tempo au BPM","Ajouter la langue des paroles au style","Contrôle uniquement les outils de paroles ; omis du style par défaut.","Fiabilité","Tous les niveaux","La fiabilité est une indication pratique, pas une garantie."],
 es:["Añadir carácter de tempo a BPM","Añadir idioma de la letra al estilo","Solo controla las herramientas de letras; se omite del estilo por defecto.","Fiabilidad","Todos los niveles","La fiabilidad es una orientación práctica, no una garantía."],
 it:["Aggiungi il carattere del tempo ai BPM","Aggiungi la lingua del testo allo stile","Controlla solo gli strumenti per i testi; esclusa dallo stile per impostazione predefinita.","Affidabilità","Tutti i livelli","L'affidabilità è una guida pratica, non una garanzia."],
 pt:["Adicionar caráter de tempo ao BPM","Adicionar idioma da letra ao estilo","Controla apenas as ferramentas de letras; omitido do estilo por padrão.","Confiabilidade","Todos os níveis","A confiabilidade é uma orientação prática, não uma garantia."],
 "pt-BR":["Adicionar caráter de tempo ao BPM","Adicionar idioma da letra ao estilo","Controla apenas as ferramentas de letras; omitido do estilo por padrão.","Confiabilidade","Todos os níveis","A confiabilidade é uma orientação prática, não uma garantia."],
 nl:["Tempokarakter aan BPM toevoegen","Taal van songtekst aan stijl toevoegen","Stuurt alleen de teksthulpmiddelen; standaard niet in de stijl opgenomen.","Betrouwbaarheid","Alle niveaus","Betrouwbaarheid is een praktische richtlijn, geen garantie."],
 pl:["Dodaj charakter tempa do BPM","Dodaj język tekstu do stylu","Steruje tylko narzędziami tekstu; domyślnie pomijany w stylu.","Niezawodność","Wszystkie poziomy","Niezawodność jest praktyczną wskazówką, a nie gwarancją."],
 sv:["Lägg till tempokaraktär till BPM","Lägg till textens språk i stil","Styr endast textverktygen; utelämnas från stil som standard.","Tillförlitlighet","Alla nivåer","Tillförlitlighet är en praktisk vägledning, inte en garanti."],
 no:["Legg til tempokarakter til BPM","Legg til tekstspråk i stil","Styrer bare tekstverktøyene; utelates fra stil som standard.","Pålitelighet","Alle nivåer","Pålitelighet er en praktisk veiledning, ikke en garanti."],
 fi:["Lisää tempon luonne BPM-arvoon","Lisää sanoituksen kieli tyyliin","Ohjaa vain sanoitustyökaluja; jätetään oletuksena pois tyylistä.","Luotettavuus","Kaikki tasot","Luotettavuus on käytännön ohje, ei takuu."],
 da:["Tilføj tempokarakter til BPM","Tilføj tekstsprog til stil","Styrer kun tekstværktøjerne; udelades som standard fra stil.","Pålidelighed","Alle niveauer","Pålidelighed er en praktisk vejledning, ikke en garanti."],
 ja:["BPMにテンポの特徴を追加","歌詞の言語をスタイルに追加","歌詞ツールのみに使用され、標準ではスタイルに含まれません。","信頼性","すべてのレベル","信頼性は実用的な目安であり、保証ではありません。"],
 ko:["BPM에 템포 특성 추가","가사 언어를 스타일에 추가","가사 도구에만 적용되며 기본적으로 스타일에서는 제외됩니다.","신뢰도","모든 단계","신뢰도는 실용적인 지침이며 보장이 아닙니다."],
 "zh-CN":["为 BPM 添加速度特征","将歌词语言添加到风格","仅控制歌词工具；默认不写入风格。","可靠性","所有级别","可靠性是实用参考，并非保证。"],
 "zh-TW":["為 BPM 加入速度特徵","將歌詞語言加入風格","僅控制歌詞工具；預設不寫入風格。","可靠性","所有等級","可靠性是實用參考，並非保證。"],
 tr:["BPM'ye tempo karakteri ekle","Şarkı sözü dilini stile ekle","Yalnızca söz araçlarını kontrol eder; varsayılan olarak stilde yer almaz.","Güvenilirlik","Tüm seviyeler","Güvenilirlik pratik bir kılavuzdur, garanti değildir."],
 ru:["Добавлять характер темпа к BPM","Добавлять язык текста в стиль","Управляет только инструментами текста; по умолчанию не включается в стиль.","Надёжность","Все уровни","Надёжность — практический ориентир, а не гарантия."]
};
function translateV207Controls(){const a=V207_I18N[currentUiLanguage]||V207_I18N.en;const ids=["tempoDescriptorLabel","languageInStyleLabel","languageStyleHint","instrumentReliabilityLabel","reliabilityAllOption","reliabilityHint"];ids.forEach((id,i)=>{const e=document.getElementById(id);if(e)e.textContent=a[i]});}
