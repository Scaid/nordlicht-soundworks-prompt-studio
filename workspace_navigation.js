...
const groups={create:['randomView','composerView','vocalDirectorView','styleView','lyricsView','promptChatView','assistantView'],analyze:['dnaAnalyzerView','optimizerView','successPredictorView','evolutionView','learningView'],knowledge:['metatagsView','styleLibraryView','blueprintView','instrumentsView','instrumentEvolutionView','genreEvolutionView','vocalsView','storyView','productionView','theoryView'],project:['projectManagerView','presetsView']};
...
const names={randomView:'Smart Randomizer',composerView:'AI Composer',vocalDirectorView:'Vocal Director',styleView:'Style Builder',lyricsView:'Lyrics Workspace',promptChatView:'AI Prompt Chat',assistantView:'Offline Smart Assistant',dnaAnalyzerView:'Song DNA Analyzer',optimizerView:'Prompt Optimizer',successPredictorView:'Suno Success Predictor',evolutionView:'Prompt Evolution',learningView:'Learning Engine',metatagsView:'Prompt Intelligence',styleLibraryView:'Style Library',blueprintView:'Song Blueprint',instrumentsView:'Instrument Library',instrumentEvolutionView:'Instrument Evolution',genreEvolutionView:'Genre Evolution',vocalsView:'Vocal Intelligence',storyView:'Story & Emotion',productionView:'Production Intelligence',theoryView:'Musical Intelligence',projectManagerView:'Project Manager',presetsView:'Presets',homeView:'Home'};
...
function groupOf(view){const nav=q(`.nav[data-view="${view}"]`);const domGroup=nav?.closest('.workspace-nav-group')?.dataset.workspace;if(domGroup)return domGroup;return Object.keys(groups).find(k=>groups[k].includes(view))||'create'}
