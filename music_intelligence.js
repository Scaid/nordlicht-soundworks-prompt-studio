...
const MUSIC_PROFILES = {
  ...
  "Swing / Vintage Jazz": { bpm:[105,145], instruments:["Upright Bass","Grand Piano","Trumpets","Trombones","Clarinet","Saxophone Section","Hybrid Electronic Drums"], voices:["Female Lead Voice","Male Lead Voice"], partners:["Jazz","Electronic / EDM","Soul / Funk / Disco","Pop","Blues"], songTypes:["Dancefloor Anthem","Jazz Standard","Club Mix","Live Band Performance","Theme"] },
...
const SUBGENRE_HINTS = [
 {match:/electro swing|swing house|neo swing/i, instruments:["Upright Bass","Grand Piano","Trumpets","Trombones","Clarinet","Saxophone Section","Hybrid Electronic Drums"], bpm:[118,138], partners:["Swing / Vintage Jazz","Jazz","Electronic / EDM"]},
 {match:/classic swing|big band|charleston|lindy|jive|ragtime/i, instruments:["Upright Bass","Grand Piano","Trumpets","Trombones","Clarinet","Saxophone Section"], bpm:[105,155], partners:["Swing / Vintage Jazz","Jazz","Blues"]},
